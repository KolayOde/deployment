...
var webphone_api = (function () {
  ...
  function start() {
    if (
      typeof webphone_api.plhandler === "undefined" ||
      webphone_api.plhandler === null
    ) {
      return webphone_api.addtoqueue("Start", [parameters, true]);
    } else return webphone_api.plhandler.Start(parameters, true);
  }
  ...
  function stop() {
    ...
    else webphone_api.plhandler.Stop(parameters);
  }
  ...
  function register() {
    ...
    else webphone_api.plhandler.Register(parameters);
  }
  ...
  function registerex(accounts) {
    ...
    else webphone_api.plhandler.RegisterEx(accounts);
  }
  ...
  function call(number) {
    ...
    else webphone_api.plhandler.Call(number);
  }
  ...
  function videocall(number) {
    ...
    else webphone_api.plhandler.VideoCall(number);
  }
  ...
  function mutevideo(state, direction) {
    ...
    else webphone_api.plhandler.MuteVideo(state, direction);
  }
  ...
  function setvideodisplaysize(type, width, height) {
    ...
    else webphone_api.plhandler.SetVideoSize(type, width, height);
  }
  ...
  function screenshare(number, screenid) {
    ...
    else webphone_api.plhandler.ScreenShare(number, screenid);
  }
  ...
  function stopscreenshare() {
    ...
    else webphone_api.plhandler.StopScreenShare();
  }
  ...
  function hangup() {
    ...
    else webphone_api.plhandler.Hangup();
  }
  ...
  function accept() {
    ...
    else return webphone_api.plhandler.Accept();
  }
  ...
  function reject() {
    ...
    else webphone_api.plhandler.Reject();
  }
  ...
  function ignore() {
    ...
    else webphone_api.plhandler.Ignore();
  }
  ...
  function getregfailreason(callback, extended) {
    if (
      ...
      webphone_api.Log(
        "ERROR, webphone_api: getregfailreason webphone_api.plhandler is not defined"
      );
  }
  ...
  function play(start, file, looping, toremotepeer) {
    if (
      ...
      return webphone_api.plhandler.PlaySound(
        start,
        file,
        looping,
        toremotepeer
      ...
      webphone_api.Log(
        "ERROR, webphone_api: play webphone_api.plhandler is not defined"
      );
    return false;
  }
  ...
  function getavailablecallfunc() {
    if (
      ...
      webphone_api.Log(
        "ERROR, webphone_api: getavailablecallfunc webphone_api.plhandler is not defined"
      );
  ...
  function forward(number) {
    ...
    else webphone_api.plhandler.Forward(number);
  }
  ...
  function conference(number, add) {
    ...
    else webphone_api.plhandler.Conference(number, add);
  }
  ...
  function transfer(number) {
    ...
    else webphone_api.plhandler.Transfer(number);
  }
  ...
  function dtmf(msg) {
    ...
    else webphone_api.plhandler.Dtmf(msg);
  }
  ...
  function mute(state, direction) {
    ...
    else return webphone_api.plhandler.MuteEx(state, direction);
  }
  ...
  function hold(state) {
    ...
    else return webphone_api.plhandler.Hold(state);
  }
  ...
  function sendchat(number, msg, group) {
    ...
    else webphone_api.plhandler.SendChat(number, msg, group);
  }
  ...
  function sendsms(number, msg, from) {
    ...
    else webphone_api.plhandler.SendSms(number, msg, from);
  }
  ...
  function getdevicelist(dev, callback) {
    if (
      ...
      if (typeof dev === "undefined" || dev === null || dev.length < 1)
        dev = "-12";
 ...
 */
  ...
  function addcontact(fullname, number, email, address, notes, website) {
    if (
      ...
      return webphone_api.plhandler.AddContact(
        fullname,
        number,
        email,
        address,
...
*/
  ...
  function setparameter(param, value) {
    ...
    if (
      ...
      webphone_api.Log(
        "WARNING, webphone not initialized yet. webphone_api.setparameter AddToQueue: " +
          param +
          ": " +
          value
      );
      ...
      if (param === "password") {
        valtoprint = "*****";
      } //|| param === 'sipusername' || param === 'username'
      webphone_api.Log(
        "EVENT, webphone_api.setparameter: " + param + ": " + valtoprint
      );
  ...
  function getparameter(param) {
    ...
    if (
      ...
      if (typeof console !== "undefined" && console !== null) {
        if (typeof console.error !== "undefined" && console.error !== null) {
          console.error(err_msg);
        } else if (typeof console.log !== "undefined" && console.log !== null) {
          console.log(err_msg);
        }
      }
    }
  ...
  function linetocallid(line, callback) {
    ...
    webphone_api.Log(
      "ERROR, webphone_api: linetocallid webphone_api.plhandler is not defined"
    );
  }
  ...
  function callidtoline(callid, callback) {
    ...
    webphone_api.Log(
      "ERROR, webphone_api: callidtoline webphone_api.plhandler is not defined"
    );
  }
  ...
  function setsipheader(header) {
    if (
      ...
      webphone_api.Log(
        "ERROR, webphone_api: setsipheader webphone_api.plhandler is not defined"
      );
  }
  ...
  function getsipheader(header, callback) {
    ...
    if (
      ...
      webphone_api.Log(
        "ERROR, webphone_api: getsipheader webphone_api.plhandler is not defined"
      );
  }
  ...
  function getsipmessage(dir, type, callback) {
    ...
    if (
      ...
      webphone_api.Log(
        "ERROR, webphone_api: getsipmessage webphone_api.plhandler is not defined"
      );
  }
  ...
  function getworkdir(callback) {
    ...
    else return "ERROR, getworkdir webphone_api.plhandler is not defined";
  }
  ...
  function delsettings(level) {
    if (
      ...
      webphone_api.Log(
        "ERROR, webphone_api: delsettings webphone_api.plhandler is not defined"
      );
  }
  ...
  function getenginename() {
    if (
      ...
      webphone_api.Log(
        "ERROR, webphone_api: getenginename webphone_api.plhandler is not defined"
      );
  }
  ...
  function getlastrecinvite(callback) {
    ...
    else return "ERROR, getlastrecinvite webphone_api.plhandler is not defined";
  }
  ...
  function getlogs() {
    if (
      ...
      webphone_api.Log(
        "ERROR, webphone_api: getlogs webphone_api.plhandler is not defined"
      );
  }
  ...
  function jvoip(name, jargs) {
    if (
      ...
      webphone_api.Log(
        "ERROR, webphone_api: jvoip webphone_api.plhandler is not defined"
      );
  }
...
*/
  ...
  function getStatus() {
    ...
    else return webphone_api.plhandler.GetStatus();
  }
  ...
  function LogEx(msg, err) {
    if (typeof msg === "undefined" || msg === null) {
      return;
    }
    if (typeof err !== "undefined" || err !== null) {
      if (msg.indexOf("ERROR") == 0) msg = msg + " " + err;
      else msg = "ERROR," + msg + " " + err;
    }
    webphone_api.Log(msg);
  }
  function Log(msg) {
    if (
      webphone_api.parameters &&
      (webphone_api.parameters["logtoconsole"] == "false" ||
        webphone_api.parameters["logtoconsole"] == false)
    ) {
      return;
    }
  ...
  function addtoqueue(name, arguments) {
    if (typeof webphone_api === "undefined" || webphone_api === null)
      return false;
    if (
      typeof webphone_api.helper === "undefined" ||
      webphone_api.helper === null
    )
      return false;
    if (
      typeof webphone_api.helper.AddToQueue === "undefined" ||
      webphone_api.helper.AddToQueue === null
    )
      return false;
  ...
  function IsSDK() {
    // must be used because webphone_api.parameters.issdk might be converted from boolean to string (so all the IF comparisons will fail)
    try {
      if (
        webphone_api &&
        webphone_api.common &&
        typeof webphone_api.common !== "undefined"
      )
        return webphone_api.common.IsSDK();

      var tmp = null;
      if (
        window &&
        typeof window.pageissdk !== "undefined" &&
        window.pageissdk !== null &&
        (window.pageissdk == "false" ||
          window.pageissdk == false ||
          window.pageissdk == true ||
          window.pageissdk == "true")
      ) {
        if (
          typeof window.pageissdk !== "undefined" &&
  ...
  function LoadScriptFile(url, callback, errorcallback) {
    // used instead of document.write
    try {
      ...
      if (typeof head === "undefined" || head === null) {
        ...
        if (typeof head === "undefined" || head === null)
          head = document.getElementsByTagName("div")[0];
        if (typeof head === "undefined" || head === null)
          head = document.getElementsByTagName("p")[0];
        if (typeof head === "undefined" || head === null)
          head = document.getElementsByTagName("a")[0];
        if (typeof head === "undefined" || head === null) {
      ...
      if (url.toLowerCase().indexOf(".css") > url.length - 5) {
        ...
        if (
          typeof webphone_api.jscodeversion !== "undefined" &&
          webphone_api.jscodeversion !== null &&
          webphone_api.jscodeversion.length > 0 &&
          url.indexOf("jscodeversion=") < 0
        ) {
          if (url.indexOf("?") > 0) {
            url =
              url + "&jscodeversion=" + webphone_api.jscodeversion.toString();
          } else {
            url =
              url + "?jscodeversion=" + webphone_api.jscodeversion.toString();
          }
      ...
      LogEx("ERROR, LoadScriptFile: ", err);
    }
    try {
      if (typeof errorcallback === "function") {
        errorcallback();
      ...
      LogEx("ERROR, LoadScriptFileEx: ", err);
    }
  }
  ...
  try {
    ...
    if (
      typeof allscripts !== "undefined" &&
      allscripts !== null &&
      allscripts.length > 0
    ) {
      var thisScript = allscripts[allscripts.length - 1];
      if (
        typeof thisScript !== "undefined" &&
        thisScript !== null &&
        typeof thisScript.src !== "undefined" &&
        thisScript.src !== null &&
        thisScript.src.length > 0 &&
        thisScript.src.indexOf("webphone_api.js") >= 0 &&
        thisScript.src.indexOf("jscodeversion=") > 0
      ) {
        var currver = thisScript.src.substring(
          thisScript.src.indexOf("jscodeversion=") + 14
        );
        if (typeof currver !== "undefined" && currver !== null) {
          if (currver.indexOf("&") > 0) {
...
webphone_api.bd_logged = false;
webphone_api.getbasedir2 = function (forceauto) {
  try {
    if (forceauto !== true) {
      var wpbdir = webphone_api.parameters["webphonebasedir"];
      if (
        typeof wpbdir === "undefined" ||
        wpbdir === null ||
        wpbdir === "." ||
        wpbdir.length < 2
      ) {
      ...
      wpbdir = wpbdir.toString();
      try {
        wpbdir = wpbdir.replace(/^\s+|\s+$/g, "");
      } catch (err) {}
      if (wpbdir.indexOf("/") === 0) {
        wpbdir = wpbdir.substring(1);
      }
      if (wpbdir.length > 1 && wpbdir.lastIndexOf("/") < wpbdir.length - 1) {
        wpbdir = wpbdir + "/";
      }
      if (wpbdir && wpbdir.length > 0) {
        if (webphone_api.bd_logged !== true) {
          try {
            if (
              webphone_api.parameters["logtoconsole"] != "false" &&
              webphone_api.parameters["logtoconsole"] != false
            ) {
              console.log("base diectory - webphonebasedir(helper): " + wpbdir);
            }
          } catch (err) {}
        }
        webphone_api.bd_logged = true;
        return wpbdir;
      }
    }
    ...
    if (scriptElements) {
      for (var i = 0; i < scriptElements.length; i++) {
        wpbdir = scriptElements[i].src;
        if (wpbdir && wpbdir.indexOf("webphone_api.js") > -1) {
          wpbdir = wpbdir.substring(0, wpbdir.indexOf("webphone_api.js"));
          if (webphone_api.bd_logged !== true) {
            try {
              if (
                webphone_api.parameters["logtoconsole"] != "false" &&
                ...
                console.log(
                  "base diectory - webphonebasedir(guessed): " + wpbdir
                );
              }
            } catch (err) {}
          }
    ...
    try {
      console.log("ERROR, webphone_api getbasedir2");
    } catch (err2) {}
  }
  return "";
};
webphone_api.LoadScriptFile(
  webphone_api.getbasedir2() + "webphone_config.js",
  function () {
    webphone_api.LoadScriptFile(
      webphone_api.getbasedir2() + "js/lib/api_helper.js",
      function () {}
    );
  }
);
